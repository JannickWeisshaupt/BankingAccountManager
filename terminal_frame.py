...
class TerminalFrame(tk.Toplevel):
    def __init__(self, master, shared_vars):
        ...
        self.clear_interpreter_button = ttk.Button(mini_command_line_frame, text='Restart interpreter', command=self.PyTerm.restart_interpreter and self.PyTerm.run_code(self.start_code),takefocus=False)
